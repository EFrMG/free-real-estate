...
export default function ChatPanel({
  ...
  if (!chats.length) {
    return (
      <div className="md:sticky md:top-[7.5vh] md:h-full max-h-[30vh] flex flex-col chat-card">
  ...
  return (
    <div className="md:sticky md:top-[7.5vh] md:h-full max-h-[88vh] flex flex-col gap-4">
